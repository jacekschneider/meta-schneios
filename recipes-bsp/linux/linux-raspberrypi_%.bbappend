...
SRC_URI += "file://custom-trigger-overlay.dts;subdir=git/arch/arm/boot/dts/overlays \
        "
SRC_URI += "file://custom-tft3-5-display-overlay.dts;subdir=git/arch/arm/boot/dts/overlays \
        "
...
RPI_KERNEL_DEVICETREE_OVERLAYS:append = " overlays/custom-tft3-5-display.dtbo"
