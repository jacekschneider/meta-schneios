...
python do_compile() {
    ...
    shutil.copyfile(os.path.join(kernel_deploydir, "zImage"), "zImage")
    root_node.fitimage_emit_section_kernel("kernel-1", "zImage", "none",
...
do_deploy() {
    ...
    install -m 0644 "${B}/fitImage" "$deploy_dir/image.ub"
